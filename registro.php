    ...
    <body>
        ...
        <div class="row container">
            <form class="col s12 formulario" id="f" onSubmit="return comprobarContraseña()" action="servidor/registrarse.php" method="POST">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <input id="password2" name="password" required="required" type="password" class="validate">
                        <label for="password2" data-error="Las contraseñas no coinciden">Repite Contraseña</label>
                    </div>
                </div>
                <?php
                if (isset($_GET['error'])) {
